                            ...
                            <div class="good-item">
                                ...
                                <div class="good-desc">
                                    ...
                                    <div class="good-btn">
                                        ...
                                        <van-stepper integer async-change @change="onChange" :min="1" :max="item.goods.stock" :name="item.id" :model-value="item.num"/>
                                    </div>
                                </div>
                            </div>
                            <template #right>
...
<script>
    ...
    import {getCart,deleteCartItem,modifyCart,checkedCart} from "@/network/cart";
